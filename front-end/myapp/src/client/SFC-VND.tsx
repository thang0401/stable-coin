...
pub mod sfcvnd {
    ...
    pub fn tribute_asset(ctx: Context<VaultAccount>, amount: u64) -> Result<()> {
    ...
    pub fn summon_asset(ctx: Context<VaultAccount>, amount: u64) -> Result<()> {
        if ctx.accounts.vault.asset_account < amount {
            return Err(ErrorCode::NotEnoughVND.into());
        } else {
            ctx.accounts.vault.asset_account -= amount;
            ctx.accounts.donator.asset_account += amount;
